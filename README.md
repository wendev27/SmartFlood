...
**SmartFlood** is an evolving disaster-response platform developed through multiple iterations of experimentation, system redesign, AI research, IoT integration, cloud deployment, and DevSecOps learning.

This repository serves as the **canonical index and engineering history of the SmartFlood ecosystem**, documenting the evolution of the project and linking its individual implementations, experiments, and major releases.
...
Each generation represents a different stage of SmartFlood's development, from early experimentation to increasingly structured engineering, cloud deployment, and future AWS infrastructure.
...
| **V5**   | AWS migration & cloud engineering  | AWS                          | 🚧 Planned   |
...
This generation focused on exploring the initial frontend architecture, user workflows, disaster-response concepts, sensor simulation, and early AI experimentation.
...
The architecture was still being discovered, multiple approaches were tested, and some implementations were eventually abandoned or replaced.

Some historical V1 repositories may no longer run with modern dependencies or environments. They are preserved here as part of the project's development history.
...
The frontend was consolidated into a more structured monorepo while the deployment architecture went through several iterations.
...
V2 provided practical experience with application deployment and revealed architectural limitations that motivated the redesign that followed.
...
The platform evolved into a more integrated full-stack system incorporating monitoring, disaster-management workflows, AI-assisted relief allocation, and sensor data.
...
V3 was also an important turning point in the project's **engineering workflow**.

Earlier generations were primarily focused on experimentation and rapid prototyping.
...
This improvement in engineering discipline became one of the most important outcomes of the V3 generation.

---

# ☁️ V4 — Cloud-Deployed Capstone 2

V4 represents the cloud-deployed evolution of SmartFlood and the system prepared for **Capstone 2**.

The architecture moved beyond the previous deployment model and introduced independently deployed services.
...
The backend and AI services are independently deployed, providing a more modular cloud architecture.
...
V4.1 focuses on the **complete frontend design and web experience** of SmartFlood.

It builds upon the system established in V4 while developing a more complete and cohesive user-facing interface.
...
# ☁️ V5 — AWS Engineering Edition

V5 represents the next stage of SmartFlood.

Unlike previous versions, V5 is primarily intended as a **self-directed AWS and DevSecOps learning project**.

The objective is to use SmartFlood as a realistic application through which cloud infrastructure concepts can be studied and applied.

### V5 Repository

| Repository                                                   | Purpose                                                                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| [`SmartFlood-V5`](https://github.com/wendev27/SmartFlood-V5) | Planned production-oriented redesign of SmartFlood for AWS deployment and cloud-engineering experimentation. |
...
> **V5 is not simply about deploying SmartFlood on AWS. It is about learning how to engineer, secure, automate, and operate cloud infrastructure by using SmartFlood as the laboratory.**

### Status

**🚧 Planned / Active Learning**
...
The project therefore documents not only the evolution of the software, but also the evolution of the development practices used to build it.
...
These are intentionally preserved as **historical engineering artifacts**, because they document the decisions and experiments that shaped later versions of SmartFlood.
...
SmartFlood began as an academic prototype and has evolved into a long-running engineering project spanning:
...
It started with experimentation and gradually evolved into an integrated platform, a cloud-deployed capstone system, and eventually a planned AWS engineering laboratory.
